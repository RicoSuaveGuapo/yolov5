...
class Loggers():
    ...
    def on_train_batch_end(self, ni, model, imgs, targets, paths, plots, sync_bn, masks=None):
        ...
        if plots:
            ...
            if ni < 3:
                ...
                Thread(target=plot_images, args=(imgs, targets, paths, f, None, masks), daemon=True).start()
